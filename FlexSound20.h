...
extern FS_queue_t* 	FS_input_queue(
 	uint32_t 	module_id,
	uint32_t 	queue_id,
	uint32_t	queue_size);
...
extern FS_queue_t* 	FS_output_queue(
 	uint32_t 	module_id,
	uint32_t 	queue_id,
	uint32_t	queue_size);
...
//
extern int32_t		FS_queue_clear(
	FS_queue_t	*p_queue); 
// Clears the queue

extern int32_t		FS_queue_fill(
	FS_queue_t	*p_queue); 
...
//
extern int32_t		FS_queue_put_data(
	FS_queue_t	*p_queue,
	void		*p_data,
	uint32_t	n_elements );
// Place n_elements into the queue

extern int32_t		FS_queue_get_data(
	FS_queue_t	*p_queue,
	void		*p_data,
	uint32_t	n_elements );
...
//
extern int32_t		FS_set_config(
	uint32_t 	module_id,
	void		*p_data,
 	uint32_t	n_bytes	);


extern int32_t		FS_set_param(
	uint32_t 	module_id,
	uint8_t 	param_id,
	uint32_t	param_value);

extern int32_t		FS_get_param(
	uint32_t 	module_id,
	uint8_t 	param_id);
